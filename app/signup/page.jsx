...
export default function Home() {
   return (
      <section className='flex flex-row justify-between w-11/12  h-85 m-auto relative'>
         <div className="illustration flex flex-col justify-end my-auto relative bg-red-50 w-5/12 h-8.5/10 border-2 border-red-500 rounded-3xl">
         ...
         <div className="login flex flex-col justify-center ms-16 w-6/12">
            <div className=" shadow-lg shadow-gray-200 w-10/12 flex flex-col justify-center px-7 py-10">
               <h1 className="flex flex-row text-gray-700 text-3xl font-extrabold mb-8">
                  Sign Up
               </h1>
               <form action="" method="post">
                  <div className = "relative input flex flex-col mb-4">
